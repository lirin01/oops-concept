...
//                        {"apple","ant","pen"};
//        String[] words=
        WordSearchVig wordSearch=new WordSearchVig(grid,words);
        wordSearch.solveCrossword();
    }
    private char[][] crossword;
    private List<String> words;
    private char[][] updatedCrossword;
    public WordSearchVig(char[][] crossword, List<String> words) {
